...
import "./navbar.css";
import logo from "../../assets/pex.jpg";
import cont from "../../assets/img3.jpg";
    ...
    return (
       ...
       <Link activeClass="active" to="clients" spy={true} smooth={true} offset={-50} duration={500} className="desktopMenuListItem">Clients</Link>
        ...
        <button className="desktopmenubtn" onClick={()=>{
            ...
            <img src={cont} alt="" className="desktopMenuImg"/>
            Contact me
        </button>

        <i className="fa fa-bars bar" onClick={()=>setmenu(!showmenu)}></i>
       ...
       <Link activeClass="active" to="Skills" spy={true} smooth={true} offset={-50} duration={500} className="ListItem" onClick={()=>setmenu(false)}>About</Link>
       ...
       <Link activeClass="active" to="clients" spy={true} smooth={true} offset={-50} duration={500} className="ListItem" onClick={()=>setmenu(false)}>Clients</Link>
